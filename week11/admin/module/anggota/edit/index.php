                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin" value="L" <?= ($row ['jenis_kelamin'] === "P") ? 'checked' : '' ?>>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="fomr-control" name="username" value="<?= $row['username']; ?>">
                                </div>
                                <div class="mb-3">
