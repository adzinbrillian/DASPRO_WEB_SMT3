<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i class="fa fa-plus"></i> Tambah Anggota</button>
                </div>
            </div>
            <?php
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td><?= $row['username']; ?></td>
                                <td>
                                    <a href="index.php?page=anggota/edit&id=<?= $row['user_id'] ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                    <a href="fungsi/hapus.php?anggota=hapus&id=<?= $row['user_id'] ?>" onclick="javascript:return confirm('Hapus Data Anggota ?');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" aria-hidden="true"></i> Hapus</a>
                                </td>
                            </tr>
                        <?php
                        }
                    ...
                    <div class="modal-content">
                        ...
                        <form action="fungsi/tambah.php?anggota=tambah" method="post">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="fomr-check-label" for="inlineRadio1">Laki-Laki</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin" value="P">
                                        <label class="fomr-check-label" for="inlineRadio2">Perempuan</label>
                                    </div>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fa fa-times" aria-hidden="true"> Close</i></button>
